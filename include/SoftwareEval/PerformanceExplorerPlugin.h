...
#ifndef PERFORMANCE_EXPLORER_PLUGIN_H
#define PERFORMANCE_EXPLORER_PLUGIN_H
...
class PerformanceExplorerPlugin : public etiss::plugin::TracerPlugin::TracerPlugin
{
public:
  PerformanceExplorerPlugin(etiss::Configuration*);
  ~PerformanceExplorerPlugin();
...
#endif // PERFORMANCE_EXPLORER_PLUGIN_H
