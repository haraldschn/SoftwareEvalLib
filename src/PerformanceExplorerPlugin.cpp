...
PerformanceExplorerPlugin::PerformanceExplorerPlugin(etiss::Configuration* config)
{

  std::cout << "Hello from the EXPLORER" << std::endl;
...
PerformanceExplorerPlugin::~PerformanceExplorerPlugin()
{
  delete channel_ptr;
...
std::string PerformanceExplorerPlugin::_getPluginName() const
{
  return "PerformanceExplorerPlugin";
}

void *PerformanceExplorerPlugin::getPluginHandle()
{
  return this;
}

void PerformanceExplorerPlugin::processTrace(void)
{
...
void PerformanceExplorerPlugin::finalizeTrace(void)
{
  //estimator_ptr->execute();
